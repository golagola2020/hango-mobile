...
url = 'http://localhost:80/rasp/drink/read'
...
def main():
    ...
    while port.readable:
        ...
        dict_result = {
            ...
            'serialNumber' : '20200814042555141', #if you pull server, then serialNumber -> serial_number

            'drink' : drink_mid[2:-1] #drink -> sold_position
        ...
        json_vending_result = json.dumps(dict_result)# dictionary -> json
